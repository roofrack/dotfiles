...
> - Any additional dotfiles added later to the _~/dotfiles/startup_files/dotfiles/ directory will be sym-linked to the users home root directory when re-running the \_sym_link_ script.
