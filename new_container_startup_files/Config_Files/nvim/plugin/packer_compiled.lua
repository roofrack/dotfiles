...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/rob/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/home/rob/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
    url = "https://github.com/rebelot/kanagawa.nvim"
  },
  kommentary = {
    loaded = true,
    path = "/home/rob/.local/share/nvim/site/pack/packer/start/kommentary",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/rob/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["vim-tmux-runner"] = {
    loaded = true,
    path = "/home/rob/.local/share/nvim/site/pack/packer/start/vim-tmux-runner",
